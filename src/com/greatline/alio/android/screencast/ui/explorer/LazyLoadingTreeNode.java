package com.greatline.alio.android.screencast.ui.explorer;
...
import com.greatline.alio.android.screencast.ui.worker.SwingWorker;
...
public abstract class LazyLoadingTreeNode extends DefaultMutableTreeNode
	...
	protected static class CancelWorkersAction extends AbstractAction {
		...
		public void actionPerformed(ActionEvent e) {
			...
			while (it.hasNext()) {
				SwingWorker<MutableTreeNode[], ?> worker = (SwingWorker<MutableTreeNode[], ?>) it
						.next();
				worker.cancel(true);
			}
